...
from dictionary import distVDW
...
def createSurface(atomscoor,atomtypes_protein,batch=None,sup_sampling=5,smoothness=0.01,variance=0.001,n_iter=4, probe=1.0,scales=[1.5],threshold=-0.7,reg=0.01,device="cuda"):
    ...
    #rolls a 'water' probe ball (1.4-1.8 Å diameter) over the Van der Waals surface
