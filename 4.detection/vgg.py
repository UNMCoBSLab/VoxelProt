...
class VGG_net(nn.Module):
  ...
  """
  def __init__(self,channel_in=6,num_classes=2,depth=4,stride=1,only_occupied=False,momentum=0.01,eps=0.001,max_buffer = int(2e8)):
  ...
  def forward(self,octree,batch_size):
    ...
    #D=self.input_signal(octree)[:,0:6]
